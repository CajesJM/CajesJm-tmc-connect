...
export default function MainAdminAttendance() {
  ...
  const handleSendPenalty = async () => {
    ...
    try {
      ...
      showAlert(
        'Success',
        `Penalties sent to ${studentIds.length} students successfully!`
      )
    } catch (error) {
        ...
        <View style={styles.modernModalOverlay}>
          ...
          >
            ...
            >
              ...
              <ScrollView
                style={[
                  styles.expirationModalContent,
                  isMobile && styles.expirationModalContentMobile,
                ]}
                showsVerticalScrollIndicator={false}
              >
                <Text
                          ...
                          >
                            <View
                              style={[
                                styles.modernModalIconContainer,
                                isMobile &&
                                  styles.modernModalIconContainerMobile,
                              ]}
                            >
                              <Feather
                                name='calendar'
                            ...
                            >
                              <Text
                                style={[
                                  ...
                                  isMobile &&
                                    styles.modernSubmitButtonTextMobile,
                                ]}
                              >
                                Confirm
                              </Text>
