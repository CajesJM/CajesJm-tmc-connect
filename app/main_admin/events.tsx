      ...
      >
        ...
        <View style={styles.paginatedInfo}>
          <View style={styles.paginatedTitleRow}>
            ...
            <View style={styles.paginatedBadgeContainer}>
              {item.status && (
                ...
                >
                  <Text style={styles.paginatedBadgeText}>
          ...
          <View style={styles.paginatedLocationRow}>
            ...
            <Text
              style={[styles.paginatedLocation, { marginLeft: 4 }]}
              numberOfLines={1}
            >
              {item.location}
            </Text>
...
export default function MainAdminEvents() {
  ...
  const [selectedEventUserLocation, setSelectedEventUserLocation] = useState<{
    latitude: number
    longitude: number
  } | null>(null)
  const [selectedEventIsWithinRange, setIsSelectedEventWithinRange] = useState<
    boolean | null
  >(null)
  ...
  const handleCreateEvent = async () => {
    ...
    try {
      ...
      const locationImageRef = selectedCampusLocation
  ...
  const handleEditEvent = (event: Event) => {
    try {
      ...
      if (event.locationImage) {
        const campusLocation = CAMPUS_LOCATIONS.find(
          (loc) => loc.id === event.locationImage
        )
        if (campusLocation) {
  ...
  const getEventStatusBadge = (eventDate: Date) => {
    ...
    if (diffDays === 0)
      return { text: 'TODAY', type: 'today', color: '#16a34a' }
    if (diffDays === 1)
      return { text: 'TOMORROW', type: 'tomorrow', color: '#2563eb' }
    if (diffDays > 1)
      return { text: 'UPCOMING', type: 'upcoming', color: '#8b5cf6' }
      ...
      >
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <Text
              style={[
                ...
                isMobile && styles.searchResultLocationMobile,
                { marginLeft: 4 },
              ]}
              numberOfLines={1}
            >
        ...
        <Text
          style={[
            ...
            isMobile && styles.searchResultDescriptionMobile,
          ]}
          numberOfLines={2}
        >
          {item.description}
        ...
        <View style={styles.searchResultFooter}>
          ...
          <View style={styles.searchResultAttendees}>
            ...
            <Text
              style={[
                styles.searchResultAttendeesText,
                isMobile && styles.searchResultAttendeesTextMobile,
              ]}
            >
  ...
  const renderSelectedDetail = (
    ...
    return (
      <View>
        <View
          style={[
            styles.modernDetailImageContainer,
            isMobile && styles.modernDetailImageContainerMobile,
          ]}
        >
          <Image
          ...
          <View
            style={[
              styles.modernDetailImageBadge,
              { backgroundColor: getEventStatusBadge(selected.date).color },
            ]}
          >
        ...
        <Text
          style={[
            styles.modernDetailTitle,
            isMobile && styles.modernDetailTitleMobile,
          ]}
        >
          {selected.title}
        </Text>
        ...
        <View style={styles.modernDetailSection}>
          ...
          <Text
            style={[
              ...
              isMobile && styles.modernDetailTextMobile,
            ]}
          >
        ...
        <View style={styles.modernDetailRow}>
          ...
          <Text style={styles.modernDetailRowText}>{selected.location}</Text>
        </View>
        ...
        {selected.coordinates && (
          <View style={styles.modernDetailSection}>
            ...
            <View style={styles.modernDetailRow}>
              ...
              <TouchableOpacity
                onPress={() =>
                  onOpenMaps(selected.location, selected.coordinates)
                }
                style={[
                  styles.modernDetailIconButton,
        ...
        <View
          style={[
            ...
            isMobile && styles.modernFormActionsMobile,
          ]}
        >
          <TouchableOpacity
            style={[
          ...
          <TouchableOpacity
            style={[
              ...
              isMobile && styles.modernCancelButtonMobile,
            ]}
            onPress={() => {
          ...
          >
            <Text
              style={[
                ...
                isMobile && styles.modernCancelButtonTextMobile,
              ]}
            >
              Delete
            </Text>
      ...
      <View style={[styles.mainContent, isMobile && styles.mainContentMobile]}>
        ...
        <View style={[styles.leftGrid, isMobile && styles.leftGridMobile]}>
          ...
          >
            ...
            >
              <Text
                style={[styles.eventCount, isMobile && styles.eventCountMobile]}
              >
          ...
          <View style={styles.resultsInfo}>
            <Text style={styles.resultsText}>
              {filterEventsByTime(events, activeFilter).length} event
              {filterEventsByTime(events, activeFilter).length !== 1 ? 's' : ''}
          ...
          <View style={styles.modernModalOverlay}>
            <View
              style={[
                ...
                isMobile && styles.modernModalContainerMobile,
                { maxWidth: 400 },
              ]}
            >
              <View
                style={[
                  ...
                  isMobile && styles.modernModalHeaderMobile,
                ]}
              >
                <View
                  style={[
                    styles.modernModalHeaderLeft,
                    isMobile && styles.modernModalHeaderLeftMobile,
                  ]}
                >
                  <View
                    style={[
                      styles.modernModalIconContainer,
                      isMobile && styles.modernModalIconContainerMobile,
                    ]}
                  >
                    <Feather
                      name='calendar'
                  ...
                  <View style={styles.modernModalTitleContainer}>
                    <Text
                      style={[
                        styles.modernModalTitle,
                        isMobile && styles.modernModalTitleMobile,
                      ]}
                    >
                      Select Date & Time
                    </Text>
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.modernModalCloseButton,
                    isMobile && styles.modernModalCloseButtonMobile,
                  ]}
                >
              ...
              <View
                style={[
                  ...
                  isMobile && styles.modernModalContentMobile,
                ]}
              >
                <input
                  type='datetime-local'
          ...
          >
            ...
            >
              ...
              >
                ...
                <View style={styles.modernModalTitleContainer}>
                  ...
                  <Text
                    style={[
                      styles.modernModalSubtitle,
                      isMobile && styles.modernModalSubtitleMobile,
                    ]}
                  >
            ...
            >
              ...
              <View style={styles.modernFormGroup}>
                <Text
                  style={[
                    styles.modernFormLabel,
                    isMobile && styles.modernFormLabelMobile,
                  ]}
                >
                  Location Name
                </Text>
              ...
              <View style={styles.modernFormGroup}>
                ...
                <FormTextInput
                  ...
                  style={[
                    ...
                    isMobile && styles.modernFormInputMobile,
                  ]}
                  multiline
                  numberOfLines={3}
                ...
                <View style={styles.characterCounterContainer}>
                  ...
                  >
                    {newEvent.locationDescription.length}/
                    {MAX_LOCATION_DESC_LENGTH} characters
                  </Text>
                  {newEvent.locationDescription.length >=
                    MAX_LOCATION_DESC_LENGTH && (
                    <Text style={styles.characterCounterWarning}>
                      Limit reached
                    </Text>
                  )}
            ...
            >
              ...
              <View style={styles.modernFormGroup}>
                ...
                <FormTextInput
                  ...
                  onChangeText={(text: string) =>
                    handleCoordinateChange('radius', text)
                  }
                  keyboardType='numeric'
                />
                <Text style={styles.modernLocationButtonSubtitle}>
      ...
      >
        ...
        >
          ...
          >
            ...
            <ScrollView
              style={[
                styles.glassModalBody,
                isMobile && styles.glassModalBodyMobile,
              ]}
              showsVerticalScrollIndicator={false}
            >
              {selectedEvent &&
