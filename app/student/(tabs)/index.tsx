...
export default function StudentDashboard() {
  ...
  const fetchRecentEvents = () => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        // Filter only upcoming events (date > now) and take first 5
        const now = new Date()
  ...
  const onRefresh = React.useCallback(() => {
    ...
    Promise.all([fetchStudentStats(), fetchDonutData()]).finally(() =>
      setRefreshing(false)
    )
  }, [rotateAnim])
      ...
      case 'event':
        router.push(
          notification.data?.eventId
            ? `/student/events?id=${notification.data.eventId}`
            : '/student/events'
        )
        break
      case 'announcement':
        router.push(
          notification.data?.announcementId
            ? `/student/announcements?id=${notification.data.announcementId}`
  ...
  const navigateTo = (screen: string, id?: string) => {
    ...
    switch (screen) {
      ...
      case 'announcements':
        router.push(
          id ? `/student/announcements?id=${id}` : '/student/announcements'
        )
        break
      case 'profile':
  ...
  const InteractiveDonutChart = () => {
    const total =
      donutData.upcomingEvents + donutData.pastEvents + donutData.announcements
    ...
    if (total === 0) {
      return (
        <Animated.View
          style={[styles.donutChartContainer, { opacity: fadeAnim }]}
        >
            ...
            <View style={styles.donutHeaderLeft}>
              <View
                style={[
                  ...
                  {
                    backgroundColor: `${colors.accent?.primary || '#0ea5e9'}20`,
                  },
                ]}
              >
                <Ionicons
        ...
        >
          ...
          <View style={[styles.column, styles.upcomingColumn]}>
            <View style={styles.upcomingCard}>
              <LinearGradient
                colors={
                  isDark ? ['#1e293b', '#0f172a'] : ['#ffffff', '#f8fafc']
                }
                              ...
                              >
                                ...
                                <View style={styles.eventInfo}>
                                  ...
                                  <View style={styles.eventMetaRow}>
                                    ...
                                    <Text style={styles.eventMetaDivider}>
                                      •
                                    </Text>
                                    <Ionicons
                            ...
                            >
                              ...
                              <View style={styles.announcementContent}>
                                ...
                                <View style={styles.announcementMetaRow}>
                                  ...
                                  <Text style={styles.announcementMetaDivider}>
                                    •
                                  </Text>
