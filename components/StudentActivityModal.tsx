...
import { FlatList, Modal, Text, TouchableOpacity, TouchableWithoutFeedback, useWindowDimensions, View } from 'react-native';
...
const ActivityRow = React.memo(({ item, colors, isDark, isMobile }: ActivityRowProps) => {
            ...
            <TouchableWithoutFeedback onPress={onClose}>
                ...
                >
                    <TouchableWithoutFeedback>
                        ...
                        >
                            <LinearGradient
                                colors={isDark ? ['#0f172a', '#1e293b'] : ['#1e40af', '#3b82f6']}
                                start={{ x: 0, y: 0 }}
                                end={{ x: 1, y: 1 }}
                                style={{
                            ...
                            {activities.length === 0 ? (
                                <View style={{ alignItems: 'center', paddingVertical: 40 }}>
                                    <Feather name="bell" size={40} color={colors.sidebar.text.muted} />
                                    <Text style={{ marginTop: 12, fontSize: 14, color: colors.sidebar.text.muted }}>
                                ...
                                <FlatList
                                    ...
                                    contentContainerStyle={{ paddingVertical: isMobile ? 16 : 20 }}
