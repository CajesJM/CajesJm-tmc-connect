...
import { fadeIn, scaleIn, slideUp } from '../../Controller/utils/animations'
  ...
  return (
    ...
    >
      <TouchableOpacity onPress={onPress} activeOpacity={0.9}>
        ...
        <Animated.Text
          style={[styles.statNumber, { color: dynamic.textPrimary }]}
        >
          {displayValue}
        </Animated.Text>
        <Text style={[styles.statLabel, { color: dynamic.textSecondary }]}>
          {title}
        </Text>
        {subtitle && (
          <Text style={[styles.statSubtext, { color: dynamic.textMuted }]}>
            {subtitle}
          </Text>
        )}
      </TouchableOpacity>
