...
import { createBulkPenalties } from '../../Model/lib/penaltyService'
...
const PenaltyAnnouncementModal: React.FC<PenaltyAnnouncementModalProps> = ({
  ...
  const handleSendPenalty = async () => {
    if (!consequences.trim()) {
      showAlert(
        'Required Field',
        'Please enter consequences or requirements for the students.'
      )
      return
    }
    if (!deadline) {
            ...
            <View style={styles.headerTitleContainer}>
              ...
              <View>
                ...
                <Text style={styles.modalSubtitle}>
                  ...
                  {missingStudents.length !== 1 ? 's' : ''} missing
                </Text>
              </View>
            </View>
            <TouchableOpacity
          ...
          >
              ...
              <View style={styles.summaryCard}>
                ...
                <View style={styles.summaryRow}>
                  ...
                  <Text style={styles.summaryText}>
                    {missingStudents.length} recipient
            ...
            <View style={styles.actions}>
              <TouchableOpacity
                ...
                style={[
                  styles.sendButton,
                  (sending || missingStudents.length === 0) &&
                ...
                {sending ? (
                  ...
                  <>
                    ...
                    <Text style={styles.sendButtonText}>
                      Send to {missingStudents.length} Student
                      {missingStudents.length !== 1 ? 's' : ''}
                    </Text>
                  </>
                )}
