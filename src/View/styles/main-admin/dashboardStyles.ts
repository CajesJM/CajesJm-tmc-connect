...
export const createDashboardStyles = (colors: any, isDark: boolean) =>
  StyleSheet.create({
    // ─── Layout ───────────────────────────────────────────────────────────────
    container: {
      flex: 1,
    ...
    // Upcoming Events enhanced styles
    upcomingItemCard: {
      borderRadius: 16,
      marginBottom: 12,
      overflow: 'hidden',
    ...
    announcementGradientModern: {
      flexDirection: 'row',
      padding: 12,
    },
    announcementContentModern: {
      flex: 1,
    },
    announcementHeaderModern: {
      flexDirection: 'row',
      justifyContent: 'space-between',
      alignItems: 'center',
      marginBottom: 6,
    ...
    announcementPreviewModern: {
      fontSize: 12,
      marginBottom: 8,
      lineHeight: 16,
    },
    announcementFooterModern: {
      flexDirection: 'row',
      justifyContent: 'space-between',
      alignItems: 'center',
    },
    announcementTimeModern: {
      fontSize: 10,
    },
    // Activity Card (new)
    activityCard: {
    ...
    // Header row and page size selector (add above the activity list)
    activityHeaderRow: {
      flexDirection: 'row',
      justifyContent: 'space-between',
      alignItems: 'center',
