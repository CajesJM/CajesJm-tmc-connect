...
export const createUsersStyles = (
  colors: ThemeColors,
  isDark: boolean,
  isMobile: boolean,
  isTablet: boolean,
  ...
  return StyleSheet.create({
    ...
    statusBadgeActive: {
      backgroundColor: '#10b981', // semantic, not theme-dependent
    },
    statusBadgeInactive: {
      backgroundColor: '#ef4444', // semantic
    },
    courseGrid: {
      flexDirection: 'row',
      flexWrap: 'wrap',
    ...
    courseChipTextMobile: {
      fontSize: 12,
    },
    courseChipTextSelected: {
      color: '#ffffff',
    },
    // All the mobile-specific styles from the original (to support conditional isMobile usage)
    ...
    userCountMobile: { fontSize: 12, paddingHorizontal: 8, paddingVertical: 3 },
    ...
    paginatedNameMobile: { fontSize: 13 },
    paginatedEmailMobile: { fontSize: 10 },
    paginatedEditButtonMobile: { width: 28, height: 28, borderRadius: 6 },
    paginatedDeleteButtonMobile: { width: 28, height: 28, borderRadius: 6 },
    paginatedStatusButtonMobile: { width: 28, height: 28, borderRadius: 6 },
    ...
    searchResultEmailMobile: { fontSize: 10 },
    ...
    searchResultStatusButtonMobile: { width: 26, height: 26, borderRadius: 5 },
    searchResultRoleTextMobile: { fontSize: 10 },
